...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.PurchaseOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("OfferedPricePerTon")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DAL.Models.Dispute", b =>
                {
                    b.HasOne("DAL.Models.User", "Mediator")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.Document", b =>
                {
                    b.HasOne("DAL.Models.Dispute", null)
                        .WithMany("Evidences")
            ...
            modelBuilder.Entity("DAL.Models.Factory", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Governorate", null)
                        .WithMany("Factories")
                        .HasForeignKey("GovernorateId");
